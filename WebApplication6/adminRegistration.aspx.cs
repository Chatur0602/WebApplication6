            ...
            try
            {
                if (Page.IsValid)
                {
...

                    {
                        ...
                        errMsg.Text = "Invalid Master Pin, Try Again";
                        errMsg.Visible = true;
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    string query1 = "insert into Users (Id, Username, Password, Usertype, Email, firstName, lastName, gender, country) values (@id, @username, @password, @usertype, @email, @firstName, @lastName, @gender, @country) ";
                                                    SqlCommand cmd1 = new SqlCommand(query1, con);
